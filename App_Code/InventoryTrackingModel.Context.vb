...
Partial Public Class InventoryTrackingEntities
    Inherits DbContext

    Public Sub New()
        MyBase.New("name=InventoryTrackingEntities")
    End Sub
    ...
    Public Property OrderLineItems() As DbSet(Of OrderLineItem)
    Public Property Products() As DbSet(Of Product)
    Public Property StorageBins() As DbSet(Of StorageBin)
    Public Property StoredProducts() As DbSet(Of StoredProduct)
